...
/* harmony import */ var _shared_interceptors_session_postfix_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/interceptors/session-postfix.interceptor */ "./src/app/shared/interceptors/session-postfix.interceptor.ts");
/* harmony import */ var _shared_interceptors_error_handler_interceptor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./shared/interceptors/error-handler.interceptor */ "./src/app/shared/interceptors/error-handler.interceptor.ts");
...
/* harmony import */ var _shared_services_auth_guard__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./shared/services/auth.guard */ "./src/app/shared/services/auth.guard.ts");
/* harmony import */ var _shared_services_snackbar_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./shared/services/snackbar.service */ "./src/app/shared/services/snackbar.service.ts");
/* harmony import */ var _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @angular/material/snack-bar */ "./node_modules/@angular/material/fesm2015/snack-bar.js");
...
/* harmony import */ var _shared_interceptors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/interceptors */ "./src/app/shared/interceptors/index.ts");


const SESSION_POSTFIX_INTERCEPTOR_PROVIDER = {
    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HTTP_INTERCEPTORS"],
    useClass: _shared_interceptors__WEBPACK_IMPORTED_MODULE_1__["SessionPostfixInterceptor"],
    multi: true
};
const ERROR_HANDLER_INTERCEPTOR_PROVIDER = {
    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HTTP_INTERCEPTORS"],
    useClass: _shared_interceptors__WEBPACK_IMPORTED_MODULE_1__["ErrorHandlerInterceptor"],
    multi: true
};
const ɵ0 = () => Promise.all(/*! import() | authorization-authorization-module-ngfactory */[__webpack_require__.e("default~authorization-authorization-module-ngfactory~profile-profile-module-ngfactory"), __webpack_require__.e("authorization-authorization-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./authorization/authorization.module.ngfactory */ "./src/app/authorization/authorization.module.ngfactory.js")).then(m => m.AuthorizationModuleNgFactory), ɵ1 = () => Promise.all(/*! import() | profile-profile-module-ngfactory */[__webpack_require__.e("default~authorization-authorization-module-ngfactory~profile-profile-module-ngfactory"), __webpack_require__.e("profile-profile-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./profile/profile.module.ngfactory */ "./src/app/profile/profile.module.ngfactory.js")).then(m => m.ProfileModuleNgFactory);
class AppModule {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _error_handler_interceptor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./error-handler.interceptor */ "./src/app/shared/interceptors/error-handler.interceptor.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ErrorHandlerInterceptor", function() { return _error_handler_interceptor__WEBPACK_IMPORTED_MODULE_0__["ErrorHandlerInterceptor"]; });

/* harmony import */ var _session_postfix_interceptor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./session-postfix.interceptor */ "./src/app/shared/interceptors/session-postfix.interceptor.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SessionPostfixInterceptor", function() { return _session_postfix_interceptor__WEBPACK_IMPORTED_MODULE_1__["SessionPostfixInterceptor"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SessionPostfixInterceptor", function() { return SessionPostfixInterceptor; });
class SessionPostfixInterceptor {
    constructor(auth) {
        this.auth = auth;
    }
    intercept(req, next) {
...
/* harmony import */ var _http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./http.service */ "./src/app/shared/services/http.service.ts");
...
class AuthService {
    ...
    isSignedIn() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].serverUrl}/CheckSession`, {})
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(true)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])((error) => {
            if (error.status === 401) {
    ...
    signIn(user) {
        const signInParams = Object.assign({ action: 'sign-in' }, user);
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].serverUrl}/UserServlet`, signInParams)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(jsessionid => localStorage.setItem('jsessionid', jsessionid)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(() => localStorage.setItem('user-login', user.login)));
    }
    signUp(user) {
        const signUpParams = Object.assign({ action: 'sign-up' }, user);
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].serverUrl}/UserServlet`, signUpParams)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(jsessionid => localStorage.setItem('jsessionid', jsessionid)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(() => localStorage.setItem('user-login', user.login)));
    }
    signOut() {
        const signOutParams = {
...
AuthService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({ factory: function AuthService_Factory() { return new AuthService(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"])); }, token: AuthService, providedIn: "root" });
...
HttpService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ factory: function HttpService_Factory() { return new HttpService(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); }, token: HttpService, providedIn: "root" });
